...
export class ArchiveComponent {
  ...
  constructor() {
    ...
    this.archiveElements = [
      {
        ...
        presidents: [
          {
            url: './assets/images/archive/2016-2017/presidents/technical.jpg',
            name: 'Nagy Edward',
      ...
      },
      {
        ...
        presidents: [
          {
            url: './assets/images/archive/2017-2018/presidents/home_secretary.jpg',
            name: 'Csutak Zsolt',
            position: 'presidents.home_secretary',
          },
          {
      ...
      },
      {
        ...
        presidents: [
          {
            url: './assets/images/archive/2018-2019/presidents/home_secretary.jpg',
            name: 'Kirsch Edgár',
            position: 'presidents.home_secretary',
          },
          {
    ...
    if (month === '12') {
      this.oldLogoLocation =
        './assets/images/archive/logo-change-event/old-logo-santa.png';
  ...
  oldLogoEasterEgg() {
    ...
    if (this.clicks >= 3) {
      this.oldLogoLocation =
        './assets/images/archive/logo-change-event/old-logo-baker.png';
    }
    if (this.clicks >= 8) {
      this.oldLogoLocation =
        './assets/images/archive/logo-change-event/old-logo-basketball.png';
    }
    if (this.clicks >= 12) {
      if (this.santaTheme) {
        this.oldLogoLocation =
        ...
        this.oldLogoLocation =
          './assets/images/archive/logo-change-event/old-logo.png';
      }
      this.clicks = 0;
    }
  }
